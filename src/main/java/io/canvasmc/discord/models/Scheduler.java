...
@Builder
@AllArgsConstructor
public class Scheduler extends FieldRegistry<Scheduler> implements EmbedModel {
    ...
    public static final Scheduler REGION = Scheduler.builder()
            ...
            .documentation("https://docs.papermc.io/paper/dev/folia-support/#region-scheduler")
            .build();
    ...
    public static final Scheduler ASYNC = Scheduler.builder()
            ...
            .documentation("https://docs.papermc.io/paper/dev/folia-support/#async-scheduler")
            .build();
    ...
    public static final Scheduler ENTITY = Scheduler.builder()
            ...
            .documentation("https://docs.papermc.io/paper/dev/folia-support/#entity-scheduler")
            .build();
